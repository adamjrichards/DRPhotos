<?php
	...
	function load_photoset( $photoset_folder, $photoset_array, $max_images_per_load, $images_per_section, $images_per_page ) {
		var_dump( $photoset_array);
